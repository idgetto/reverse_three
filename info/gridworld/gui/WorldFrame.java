...
public class WorldFrame<T> extends JFrame
{
    ...
    private JTextArea messageAreaTop;
    ...
    public WorldFrame(World<T> world)
    {
        ...
        messageAreaTop = new JTextArea(3, 35);
        messageAreaTop.setEditable(false);
        messageAreaTop.setFocusable(false);
        messageAreaTop.setBackground(new Color(0xFAFAD2));
        content.add(new JScrollPane(messageAreaTop), BorderLayout.NORTH);
        
        messageAreaRight = new JTextArea(3, 15);
        messageAreaRight.setEditable(false);
        messageAreaRight.setFocusable(false);
        messageAreaRight.setBackground(new Color(0xFAFAD2));
        content.add(new JScrollPane(messageAreaRight), BorderLayout.EAST);
    ...
    */
    public void repaint()
    {
        String messageTop = getWorld().getMessageTop();
        if (messageTop == null)
            messageTop = resources.getString("message.default");
        messageAreaTop.setText(messageTop);
        messageAreaTop.repaint();
        
        String messageRight = getWorld().getMessageRight();
        if (messageRight == null)
            messageRight = resources.getString("message.default");
        messageAreaRight.setText(messageRight);
        messageAreaRight.repaint();
