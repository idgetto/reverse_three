...
public class World<T>
{
    ...
    /**
     * Sets the message to be displayed in the world frame to the right of the grid.
     * @param newMessage the new message
     */
    ...
    /**
     * Gets the message to be displayed in the world frame to the right of the grid.
     * @return the message
     */
